# Problem I faced: Check instances of MongoDB running
...
so it will also appear in the output. For that reason you need to eliminate it by piping grep -v grep, which filters all the lines from the 
input that contain the string grep.
